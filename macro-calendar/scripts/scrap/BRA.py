...
def run(playwright: Playwright) -> None:
    ...
    # --- COUNTRY FILTER ---
    print("[INFO] Applying 'Brazil' filter...")
    ...
    ics_path = os.path.join(download_dir, f"ICS/BRA_{last_year}.ics")
    ...
    csv_path = os.path.join(download_dir, f"CSV/BRA_{last_year}.csv")
