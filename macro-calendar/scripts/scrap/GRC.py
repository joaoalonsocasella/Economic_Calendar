...
def run(playwright: Playwright) -> None:
    ...
    # --- COUNTRY FILTER ---
    print("[INFO] Applying 'Greece' filter...")
    ...
    ics_path = os.path.join(download_dir, f"ICS/GRC_{last_year}.ics")
    ...
    csv_path = os.path.join(download_dir, f"CSV/GRC_{last_year}.csv")
